              ...
              <ul className="flex items-center gap-4 ">
                ...
                <li className="relative cursor-pointer group">
                  ...
                  >
                    ...
                    <span>
                      <FaCaretDown
                        className=" group-hover:rotate-100 
                                        duration-300"
                      />
                    </span>
                  </a>
                        ...
                        <li>
                          <a
                            className="text-gray-500 hover:text-black dark:hover:text-white 
                                                            duration-200 p-2 inline-block hover:bg-primary/20 w-full
            ...
            <div className="relative group hidden sm:block">
              ...
              <IoMdSearch
                className="text-xl text-gray-600 dark:text-gray-400
                         absolute top-1/4 right-3 group-hover:text-primary duration-200"
              />
            </div>

            {/**order button section*/}
            <button className="relative p-3" onClick={handleOrderPopup}>
              <FaCartShopping className="text-gray-600 dark:text-gray-400 text-xl" />
              <div
                className="w-4 h-4 bg-red-500 text-white rounded-full absolute top-0

        ...
        <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className=" col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90
                    ...
                    <img src={xbox_1} alt="" className="w-[290px] top-1/2 absolute -translate-y-1/2 -right-0 
                        drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)]"/>
                </div>
                {/**second col */}
                <div className="py-10 pl-5 bg-gradient-to-br from-green-400/90 
                ...
                {/**third col */}
                <div className="py-10 pl-5 bg-gradient-to-br from-brandBlue/90

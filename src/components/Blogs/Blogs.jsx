...
const BlogData = [
    {
        ...
        subtitle:"minima facere deserunt veor itle beatae delemit eivs dodlores consequenstue, eleigendi corporis maiores molesteiaes laidantium, porro7",
        ...
        <div className="container flex flex-col gap-5">
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 gap-y-8 md:gap-7 sm:gap-4'>
                {/**Blog card */}
                 {
                    BlogData.map((data) =>(
                      <div className='bg-white dark:bg-gray-900'  key={data.title}>
                        {/**image section */}
